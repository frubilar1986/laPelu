...
// control dinamico de los input chekbox.
function contactar() {
...
function validaTodo() {
    ...
    if (correo.checked == true && document.getElementById("correo").value == "" || correo.checked == true && !isNaN(document.getElementById("correo").value)) {
        document.getElementById("correo").style.background = "orangered";
        exito = false;
    }
    if (telefono.checked == true && document.getElementById("telefono").value == "" && correo.checked == true && document.getElementById("correo").value == "") {
...
function validaDia() {
    ...
    if ((mes == 2 && parseInt(dia.value) == 29 && !bisiesto) || mes == 2 && parseInt(dia.value) > 29 || parseInt(dia.value) < 1 || parseInt(dia.value) > 31) {
